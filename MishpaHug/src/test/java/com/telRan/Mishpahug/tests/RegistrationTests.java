...
//        Assert.assertTrue(app.isHamburgerDisplayed());
        ...
        app.getUserHelper().fillPersonalInformationForm(new ProfilePersonalInformationData().setfName("Moshe").setlName("LastName").setPhone("545667788").
                setReligious("Religious").setYear("1974").setMonth("JAN").setDay("18"));

        app.getUserHelper().fillAboutMyselfForm(new ProfileAboutMySelfData().setStatus("In a relationship").setFoodPref("Kosher").setGender("Male").setLanguage("English").setText("text"));
